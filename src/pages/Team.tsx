                                                ...
                                                {member.user?.phone && (
                                                    <>
                                                        ...
                                                        <a
                                                            ...
                                                            className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 transition-all text-[10px] font-bold uppercase tracking-wider border border-[#25D366]/20 group"
