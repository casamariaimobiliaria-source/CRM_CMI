...
const LeadTableRow: React.FC<LeadTableRowProps> = ({ lead }) => {
    ...
    return (
        <motion.div
            ...
            className="group flex flex-col md:flex-row items-center py-5 px-5 md:px-8 transition-all cursor-pointer relative overflow-hidden hover:bg-white/[0.03] border-b border-white/5 last:border-0"
        >
