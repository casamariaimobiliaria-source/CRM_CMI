...
const Kanban: React.FC = () => {
    ...
    return (
        <div className="h-[calc(100vh-10rem)] flex flex-col overflow-hidden bg-background">
            ...
            <header className="px-5 md:px-8 py-6 md:py-10 shrink-0 border-b border-white/5 bg-background/50 backdrop-blur-3xl">
                <h1 className="text-3xl md:text-4xl font-display font-bold text-foreground italic tracking-tight">O Pipeline</h1>
                <p className="text-primary text-[10px] font-bold uppercase tracking-[0.3em] mt-2 md:mt-3">Estratégia de Movimento Fluido</p>
            </header>
            ...
            <DragDropContext onDragEnd={onDragEnd}>
                <div className="flex-1 overflow-x-auto pb-20 custom-scrollbar snap-x snap-mandatory md:snap-none scroll-smooth font-inter">
                    <div className="flex gap-4 md:gap-8 p-5 md:p-8 min-h-full w-fit">
                        {columns.map((column) => (
                            <div
                                key={column.id}
